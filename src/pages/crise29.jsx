  ...
  return (
    ...
    <div className="container">
      ...
      <nav className="main-nav">
        ...
        O consumo da população ficou muito acelerado, o que acabou elevando as compras de maneira desenfreada, esse consumo excessivo se baseou em parte no aumento do crédito que acontecia no país, que não tinha nenhum tipo de regulação ou intervenção estatal. <br />
